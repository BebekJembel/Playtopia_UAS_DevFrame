...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{ asset('frontend/img/gamingshop.png') }}" alt="" /></a>
        </div>
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    <a href="#"><i class="fa fa-gamepad"></i> <span>1</span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-gamepad"></i> <span>{{ $cartCount }}</span></a>
                </li>
            </ul>
            <div class="header__cart__price">Pembelian: <span>${{ $cartTotal }}</span></div>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="{{ route('shop.index') }}">Marketplace</a></li>
                <li>
                    <a href="#">Categories</a>
    ...
    <header class="header" style="box-shadow: 2px 2px 2px rgba(0,0,0,0.8);">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="/"><img src="{{ asset('frontend/img/gamingshop.jpg') }} " alt="" /></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu" style="padding-top:68px;">
                        <ul>
                            <li class="active"><a href="/" style="font-size: 17px;">Home</a></li>
                            <li><a href="{{ route('shop.index') }} " style="font-size: 17px;">Marketplace</a></li>
                            <li>
                                <a href="#" style="font-size: 17px;">Categories</a>
                                <ul class="header__menu__dropdown">
                                    @foreach($menu_categories as $menu_category)
                                    <li><a
                            ...
                            <li><a href="#" style="font-size: 17px;">Contact</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3">
                    <div class="header__cart" style="padding-top:68px;">
                        <ul>
                            <li>
                ...
                <div class="col-lg-12">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                <input type="text" placeholder="Cari akun game" />
